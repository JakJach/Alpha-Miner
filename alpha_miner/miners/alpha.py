...
class Alpha:
    def __init__(self, log):
        ...
        self.direct_succession = self.get_direct_succession()
        self.causal = self.get_causality(self.direct_succession)
        self.parallel = self.get_parallel(self.direct_succession)
    ...
    def get_footprint(self):
        ...
        footprint.append("Choice: {}".format(self.independent))
        return '\n'.join(footprint)
